...
## mouse buttons map
 - button 5: toggle Play/Stop ⏯️
 - button 4: Play ▶️ until button released ⏹️ 
 - Alt + button 5: toggle Solo Unsolo Track (in Bitwig you have to set Alt+s shortcut)
 - Alt + button 4: toggle Mute 🔈 Unmute 🔊 Track toggle (in Bitwig you have to set Alt+w shortcut)
